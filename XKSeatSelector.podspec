#
#  Be sure to run `pod spec lint XKSeatSelector.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "iamxiaokang"
  # s.authors            = { "iamxiaokang" => "393264532@qq.com" }
  # s.social_media_url   = "http://twitter.com/iamxiaokang"
